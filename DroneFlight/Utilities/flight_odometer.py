...
class FlightOdometer:
    ...
    def _camera_frustum_ground_border(camera: Camera, ground_level: float = 0.0) -> Tuple[Vector2, ...]:
        p = Plane(origin=Vector3(0, 0, ground_level), normal=Vector3(0, 0, -1))
    ...
    @property
    def pinhole_camera(self) -> Camera:
        return self._camera
    ...
    def _update_camera_transform_transforms(self, rotation: Quaternion, altitude, image_w: int, image_h: int) -> None:
        ...
        # elevation is z coordinate
        self._camera.transform.origin   = Vector3(0, 0, altitude)  # -altitude camera looks along z axis
        self._camera.transform.rotation = rotation
        # Vector3(90 + ax, ay, az)
    ...
    def _build_transforms(self) -> None:
        ...
        position = Vector3(self._curr_gt_transform.m02, 0, self._curr_gt_transform.m12) - \
                   self._camera.transform.origin.z / self._camera.transform.front.z * self._camera.transform.front
        # TODO end refactor
