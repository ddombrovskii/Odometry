...
def init_vect_2(parent: QWidget = None, label_str: str = "label", x_str: str = "X",
                y_str: str = "Y", vert: bool = False) -> Tuple[QWidget, QLineEdit, QLineEdit]:
...
def init_vect_3(parent: QWidget = None, label_str: str = "label", x_str: str = "X",
                y_str: str = "Y", z_str: str = "Z", vert: bool = False) ->\
...
def init_vect_4(parent: QWidget = None, label_str: str = "label", x_str: str = "\"X\"",
                y_str: str = "\"Y\"", z_str: str = "\"Z\"", w_str: str = "\"W\"", vert: bool = False) -> \
...
def init_mat_2(parent: QWidget = None, label_str: str = "label") -> [QWidget, List[QLineEdit]]:
    ...
    # First row
    row1, m00, m01 = init_vect_2(mat_container, label_str="", x_str="\"M00\"", y_str="\"M01\"")
    rows_layout.addWidget(row1)
    # Second row
    row2, m10, m11 = init_vect_2(mat_container, label_str="", x_str="\"M10\"", y_str="\"M11\"")
...
def init_mat_3(parent: QWidget = None, label_str: str = "label") -> [QWidget, List[QLineEdit]]:
    ...
    rows_layout = QVBoxLayout()
    # First row
    row1, m00, m01, m02 = init_vect_3(mat_container, label_str="", x_str="\"M00\"", y_str="\"M01\"", z_str="\"M02\"")
    rows_layout.addWidget(row1)
    # Second row
    row2, m10, m11, m12 = init_vect_3(mat_container, label_str="", x_str="\"M10\"", y_str="\"M11\"", z_str="\"M12\"")
    rows_layout.addWidget(row2)
    # Third row
    row3, m20, m21, m22 = init_vect_3(mat_container, label_str="", x_str="\"M20\"", y_str="\"M21\"", z_str="\"M22\"")
