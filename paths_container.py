...
from PyQt5.QtWidgets import QWidget, QLabel, QPushButton, QApplication, QGridLayout, QHBoxLayout, QVBoxLayout, QMessageBox, \
    QLineEdit, QComboBox
import sys
...
class PathSegmentWidget(QWidget):
    ...
    def _init_layouts(self):
        ...
        self._decimate_drop_down  = ...
        self._smoothing_drop_down = ...
        
        self._go_to_start_btn = ...
        self._go_to_end_btn   = ...
...
class PathsContainer(QWidget):
    ...
    """
    def __init__(self, width: int = 500, height: int = 500, window_name: str = "MainWindow"):
