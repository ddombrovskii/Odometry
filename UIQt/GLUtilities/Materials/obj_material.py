...
class ObjMaterial(MaterialGL):
    ...
    def __init__(self, shader: ShaderGL = None):
        ...
        self._diffuse: TextureGL = gl_globals.WHITE_TEXTURE
        self._specular: TextureGL = gl_globals.PINK_TEXTURE
        self._normals: TextureGL = gl_globals.PINK_TEXTURE
    ...
    def diffuse_texture(self, diffuse_texture: TextureGL) -> None:
        self._diffuse = gl_globals.PINK_TEXTURE if diffuse_texture is None else diffuse_texture
        with self._shader:
    ...
    def specular_texture(self, specular_texture: TextureGL) -> None:
        self._specular = gl_globals.PINK_TEXTURE if specular_texture is None else specular_texture
        with self._shader:
    ...
    def normals_texture(self, normals_texture: TextureGL) -> None:
        self._normals = gl_globals.PINK_TEXTURE if normals_texture is None else normals_texture
        with self._shader:
